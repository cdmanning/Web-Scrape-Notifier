# 🔎 Web-Scrape-Notifier [![Docker Image Version](https://img.shields.io/docker/v/cdmanning/web-scrape-notifier)](https://hub.docker.com/r/cdmanning/web-scrape-notifier)
