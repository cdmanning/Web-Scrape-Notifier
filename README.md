# 🔎 Web-Scrape-Notifier [![Docker Image Version](https://img.shields.io/docker/v/cdmanningh/web-scrape-notifier)](https://hub.docker.com/r/cdmanning/web-scrape-notifier)
